...
![Create a table from selected JSON files](../../assets/images/chapters/advanced-visualization/table-viewer-create-table.png)

NORA then asks which JSON files and which keys should be exported into the table.

![Choose JSON files and keys for the table](../../assets/images/chapters/advanced-visualization/table-viewer-select-json-keys.png)
...
![Table created from JSON metadata](../../assets/images/chapters/advanced-visualization/table-viewer-json-metadata-table.png)
...
![Import selected table columns as subject JSON metadata](../../assets/images/chapters/advanced-visualization/table-viewer-import-columns.png)
