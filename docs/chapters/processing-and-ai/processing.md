...
Use [Administration Backend](../installation-and-administration/administration-backend.md) for:
...
Use [Slurm, Queues, and Jails](../installation-and-administration/slurm-queues-and-jails.md) for queue configuration, scheduler mapping, and filesystem sandboxing.

Use [Interactive Development Services](../installation-and-administration/interactive-development-services.md) for interactive jobs such as Jupyter or code-server, which build on the same queue and jail infrastructure.
