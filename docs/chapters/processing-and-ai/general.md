...
![image-1600353714384.png](../../assets/images/chapters/processing-and-ai/general-processing-panel.png)
...
- Use [Administration Backend](../installation-and-administration/administration-backend.md) for selector syntax, tags, and CLI or Python-based file selection.
- Use [Slurm, Queues, and Jails](../installation-and-administration/slurm-queues-and-jails.md) for cluster-side queue and sandbox setup.
