...
For the administrator-facing setup behind these services, see [Interactive Development Services](../installation-and-administration/interactive-development-services.md). For queue and jail behavior, see [Slurm, Queues, and Jails](../installation-and-administration/slurm-queues-and-jails.md).
...
If you want to place files directly into backend project folders before registering them in the database, this is also the recommended path; see [Create Project From Existing Data](../data-import/create-project-from-existing-data.md).

## Launch Jupyter Lab from the main menu

Open the menu in the upper-right corner and choose Jupyter:

![image.png](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-launch-entry.png)

This opens the launcher dialog for a Jupyter job on the cluster. You can choose the queue and other job parameters there:

![image.png](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-server-dialog.png)
...
![image-1649269648564.png](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-notebook-list.png)

The notebook is then opened in a new browser tab:

![image-1649269771467.png](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-open-notebook.png)
...
![OpenSSH launch entry](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-openssh-launch-entry.png)

Configure and submit the job in the dialog:

![OpenSSH job dialog](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-openssh-job-dialog.png)

After the job is running, NORA shows the connection details:

![OpenSSH job connection details](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-openssh-connection-details.png)
...
- launching or inspecting backend-oriented workflows described in [Administration Backend](../installation-and-administration/administration-backend.md)

If the environment variable `DPXproject` is set in the interactive session, you can often omit `-p MYPROJECT`.

This also makes the Python wrappers in `src/python/nora` practical inside notebooks, especially `DPX_selectFiles`, `DPX_getMeta`, and `DPX_getOutputLocation`; see [Administration Backend](../installation-and-administration/administration-backend.md).
...
![image-1649269997390.png](../../assets/images/chapters/processing-and-ai/jupyter-notebooks-terminal-view.png)
