...
Batches are launched for every subjects/study independently in parallel. The jobs within a batch run sequentially. You can also choose different running option (see (G) in Figure 2). Depending on the selection level (subjects or studies), the batches are iterated over subjects or patients  
 ![image-1601205201699.png](../../assets/images/chapters/processing-and-ai/batchtool-overview.png)  
...
![alt text](../../assets/images/chapters/processing-and-ai/batchtool-job-configuration.png)
...
![image-1601199202182.png](../../assets/images/chapters/processing-and-ai/batchtool-job-list.png)
...
![image-1601211881748.png](../../assets/images/chapters/processing-and-ai/batchtool-results-view.png)
