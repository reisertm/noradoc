...
Open the reading tool (R) in vertical toolbar ![image.png](../../assets/images/chapters/annotation-and-reading-tools/reading-tool-toolbar-entry.png)

A list of all readings you have permission to access will appear.

 ![image.png](../../assets/images/chapters/annotation-and-reading-tools/reading-tool-case-list.png)
...
![image.png](../../assets/images/chapters/annotation-and-reading-tools/reading-tool-report-form.png)
...
![image.png](../../assets/images/chapters/annotation-and-reading-tools/reading-tool-results-view.png)
