...
For the backend setup of `pacsquery`, `storescp`, receive nodes, and move-target configuration, see [PACS and storescp Setup](../installation-and-administration/pacs-storescp-setup.md). For the related user-rights model, see [Projects, Users, and Rights](../viewer-and-daily-use/projects-users-and-rights.md).
...
![starting_pacs_query.png](../../assets/images/chapters/data-import/pacs-querier-start-query.png)

### Overview of the Query Tool GUI

![query_gui.png](../../assets/images/chapters/data-import/pacs-querier-query-form.png)
...
![query_search.png](../../assets/images/chapters/data-import/pacs-querier-search-results.png)
...
![query_patient_highlight.png](../../assets/images/chapters/data-import/pacs-querier-highlight-patient.png)
...
![selection_patients_query.png](../../assets/images/chapters/data-import/pacs-querier-select-patients.png)
...
![view_query_import.png](../../assets/images/chapters/data-import/pacs-querier-import-view.png)
...
- Use [PACS and storescp Setup](../installation-and-administration/pacs-storescp-setup.md) for PACS node setup and troubleshooting.
- Use [Projects, Users, and Rights](../viewer-and-daily-use/projects-users-and-rights.md) for PACS query and project access permissions.
