...
Use [PACS and storescp Setup](../installation-and-administration/pacs-storescp-setup.md) when scanners or PACS systems should push DICOM data directly into NORA through configured receive nodes.
...
For the access model, see [Projects, Users, and Rights](../viewer-and-daily-use/projects-users-and-rights.md). For the configuration details behind PACS receive and routing, see [PACS and storescp Setup](../installation-and-administration/pacs-storescp-setup.md).
