...
![image-1602517651838.png](../../assets/images/chapters/viewer-and-daily-use/projects-subject-studies-overview.png)
...
For the backend selector syntax, including `stag:`, `ptag:`, `tag:`, sorting, and command-line selection, see [Administration Backend](../installation-and-administration/administration-backend.md).
