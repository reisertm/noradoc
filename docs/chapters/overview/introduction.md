...
![Two example use cases for NORA](../../assets/images/chapters/overview/introduction-nora-use-cases.png)
...
2. Continue with [First Steps](../viewer-and-daily-use/first-steps.md).
