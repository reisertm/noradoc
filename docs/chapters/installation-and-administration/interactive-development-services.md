...
Use [Jupyter Notebooks](../processing-and-ai/jupyter-notebooks.md) for user-facing notebook usage.

Use [Jobs](../processing-and-ai/jobs.md) for the generic job model behind these launches.
