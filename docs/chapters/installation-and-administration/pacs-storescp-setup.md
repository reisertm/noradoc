...
`pacsquery` defines remote PACS systems that NORA can search and retrieve from, typically through the PACS Querier GUI described in [PACS Querier](../data-import/pacs-querier.md).
...
Use [PACS Querier](../data-import/pacs-querier.md) for the user-facing query GUI.
